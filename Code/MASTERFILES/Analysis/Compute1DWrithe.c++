...
writeFileWr <<"1DWrithe_" << argv[2]<< ".lp"<<lp<<".dat";
ofstream writeWr(writeFileWr.str().c_str());
writeWr << "#Timestep BeadNumber 1DUnsignedWrithe "<< endl;
//
// stringstream writeFileWrmax;
// writeFileWrmax <<"1DWritheMAX_" << argv[2]<< ".lp"<<lp<<".dat";
...
//     localargmax = kk;
// }
writeWr << k << " " << kk <<" " << allunsWr[n][kk] << endl;
